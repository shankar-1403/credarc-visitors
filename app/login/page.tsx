        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="you@credarc.org"
              className="min-h-13 w-full rounded-xl border border-white/15 bg-white/[0.06] px-4 text-white outline-none transition-colors placeholder:text-white/30 focus:border-[#0575DD]/70 focus:bg-white/10"
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="min-h-13 w-full rounded-xl border border-white/15 bg-white/[0.06] px-4 pr-14 text-white outline-none transition-colors focus:border-[#0575DD]/70 focus:bg-white/10"
              />
              <button
                type="button"
          ...
          <button
            type="submit"
            disabled={submitting}
            className="min-h-13 w-full cursor-pointer rounded-xl bg-[#0575DD] text-sm font-semibold text-brand-deep transition-colors hover:bg-[#09B6F1] disabled:cursor-not-allowed disabled:opacity-60"
          >
