...
Front-desk visitor check-in for the CREDARC office.
...
project, its own logins. It shares nothing with the CREDARC website.
...
1. **Add project** — call it something like `credarc-visitors`. **Do not reuse the
   website's project.**
...
banner in the staff area. It then opens full screen with the CREDARC mark as its
icon.
