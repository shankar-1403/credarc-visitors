  ...
  return (
    <div data-fixed-dark className="relative flex min-h-screen flex-col bg-brand-deep text-white">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -left-40 top-1/3 size-[36rem] rounded-full bg-[#0575DD]/[0.07] blur-3xl" />
      </div>
        ...
        <header className="flex items-center justify-between px-5 py-5 sm:px-8 sm:py-6 lg:px-12">
          ...
          {step !== "welcome" && step !== "status" ? (
            <button
              type="button"
              onClick={reset}
              className="flex min-h-12 cursor-pointer items-center gap-2 rounded-full border border-white/15 px-5 text-sm font-medium text-white/70 transition-colors duration-200 hover:border-white/30 hover:text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#0575DD]"
            >
          ...
          >
            ...
            {step === "welcome" ? (
              <section className="flex flex-1 flex-col items-center justify-center text-center">
                <p className="text-sm font-semibold uppercase tracking-[0.3em] text-[#0575DD]">
                ...
                <button
                  ...
                  className="group mt-12 flex min-h-20 cursor-pointer items-center gap-4 rounded-full bg-[#0575DD] px-12 text-lg font-semibold text-brand-deep shadow-2xl shadow-[#0575DD]/20 transition-all duration-200 hover:bg-[#09B6F1] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white active:scale-[0.98]"
                >
                  Check in
                ...
                <section>
                  ...
                  {presetStaff ? (
                    <p className="mt-2 text-sm text-white/50">
                      Checking in to meet{" "}
                      <span className="font-medium text-[#0575DD]">{presetStaff.name}</span>
                    </p>
                  ) : null}
                    ...
                    <div className="mt-5 flex flex-wrap gap-2">
                      {bookingDays.map((day, index) => (
                        <button
                          ...
                          className={`min-h-11 cursor-pointer rounded-full border px-5 text-sm font-medium transition-all duration-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#0575DD] ${
                            selectedDayIndex === index
                              ? "border-[#0575DD] bg-[#0575DD] text-brand-deep"
                        ...
                        <div className="grid grid-cols-3 gap-3 sm:grid-cols-4 lg:grid-cols-6">
                          {daySlots.map((slot) => (
                            <button
                              ...
                              className={`min-h-13 cursor-pointer rounded-xl border text-sm font-semibold tabular-nums transition-all duration-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#0575DD] disabled:cursor-not-allowed disabled:border-white/5 disabled:bg-transparent disabled:text-white/25 disabled:line-through ${
              ...
              <section className="flex flex-1 flex-col items-center justify-center text-center">
                {status === "pending" ? (
                  <>
                    <span aria-hidden className="relative flex size-28 items-center justify-center">
                      <span
                        className={`absolute inset-0 rounded-full bg-[#0575DD]/15 ${
                          reduceMotion ? "" : "animate-ping"
                        }`}
                      />
                      <span className="relative flex size-20 items-center justify-center rounded-full bg-[#0575DD]/20">
                        <IconClock className="size-9 text-[#0575DD]" />
                      </span>
                    </span>
                ...
                {resolved ? (
                  <button
                    type="button"
                    onClick={reset}
                    className="mt-12 min-h-14 cursor-pointer rounded-full border border-white/15 px-8 text-base font-medium text-white/60 transition-colors duration-200 hover:border-white/35 hover:text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#0575DD]"
                  >
                    Done
                  </button>
                ) : null}
...
function StatusResult({
  ...
  > = {
    ...
    postponed: {
      icon: <IconCalendarTime className="size-10 text-[#0575DD]" />,
      ring: "bg-[#0575DD]/15",
...
function KioskField({
  ...
  const fieldClassName = `min-h-13 w-full rounded-2xl border bg-white/[0.06] px-5 text-base text-white outline-none transition-colors duration-200 placeholder:text-white/30 focus:bg-white/10 ${
    error ? "border-red-400/60 focus:border-red-400" : "border-white/15 focus:border-[#0575DD]/70"
  }`;
  ...
  return (
    <div>
      ...
      >
        {label}
        {required ? <span className="ml-1 text-[#0575DD]">*</span> : null}
      </label>
      {options ? (
        <select
          id={id}
...
function NextButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={disabled}
      className="group flex min-h-16 cursor-pointer items-center gap-3 rounded-full bg-[#0575DD] px-12 text-lg font-semibold text-brand-deep shadow-xl shadow-[#0575DD]/15 transition-all duration-200 hover:bg-[#09B6F1] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white active:scale-[0.99] disabled:cursor-not-allowed disabled:bg-white/12 disabled:text-white/35 disabled:shadow-none"
    >
      {loading ? (
        <span
          aria-hidden
