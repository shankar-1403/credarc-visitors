...
export default function StaffDirectory() {
  ...
  const inputClass =
    "border border-navy-500 dark:border-white/25 rounded-4xl w-full py-2 px-3 text-navy-500 dark:text-white dark:placeholder:text-white/30 outline-none focus:ring-2 focus:ring-[#0575DD]/40";
